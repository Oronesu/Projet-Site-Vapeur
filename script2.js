document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchAndDisplayFilteredGames() {
        try {
            ...
            const apiUrlWithParams = `${proxyUrl}${apiUrl}?api_key=${apiKey}&format=json&limit=${pageSize}&offset=${randomOffset}&field_list=name,deck,image,platforms,original_release_date&filter=platforms:${pcPlatformId};original_release_date:1998-1-1 00:00:00`;
    ...
    // Lancer la récupération et l'affichage des jeux filtrés
